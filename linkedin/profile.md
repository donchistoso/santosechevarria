# LinkedIn — Santos Echevarria

**Status: profile does not exist yet.** Santos has to create the account
himself (needs his email and phone for verification — see
`linkedin/SETUP.md`). This file is the copy that goes into it, field by
field, once the account is live.
...
getting the approval, and keeping everything clean and compliant.

What that has looked like in practice:

• Lender relationships built over decades — banks, captives, and credit
  unions — that get deals approved across the full credit spectrum.
• F&I product performance recognized by the manufacturer: six-time Nissan
  Award of Excellence winner, and Platinum level in Nissan Security Plus
  products every year since 2005.
• A 15-person sales floor I supported and trained on deal structure,
  disclosure, and how to hand a customer to the finance office.
...
📞 (786) 554-0173 · ✉️ santosechevarria1@gmail.com
...
> (Truth in Lending, Red Flags Rule, OFAC). Trained sales staff on deal
> structure and finance-office hand-off. Daily operator in CDK, DealerTrack,
> and Reynolds & Reynolds.
>
> Six-time Nissan Award of Excellence winner. Platinum level in Nissan
...
> approvals through a network of banks and credit unions, and selling
...
1. **Automotive Finance & Insurance (F&I)** ← pin
2. **Deal Structuring** ← pin
3. **Lender Relationship Management** ← pin
...
## Honors & awards (Honors section, not just Experience)
...
- Photo: a clean headshot against a plain wall, in what he'd wear on the
...
- ⚠️ "Open to work": decide whether he wants the green banner (public, his
  ...
  right call while he's still at Bill Seidle.**
